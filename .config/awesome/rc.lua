...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Mod1", "Shift" }, "o", function()
	...
	awful.key({ modkey }, "Tab", awful.tag.history.restore, { description = "switch to latest tag", group = "tag" }),
	...
	awful.key({ modkey }, "m", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
	awful.key({ "Mod1" }, "F4", function()
		awful.spawn("sysact")
	end, { description = "sysact", group = "awesome" }),
...
for i = 1, 9 do
	globalkeys = gears.table.join(
		...
		awful.key({ modkey, "Mod1", "Shift" }, "#" .. i + 9, function()
			if client.focus then
				local tag = client.focus.screen.tags[i]
				if tag then
