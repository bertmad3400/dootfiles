...
mydevmenu = {
	{ "osinter-frontend", '/home/bertmad/Programmering/osinter/frontend-launch.sh'},
}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Mod1", "Shift"}, "o",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Mod1", "Shift" }, "i",     function () awful.tag.incncol(-1, nil, true)    end,
    ...
    awful.key({ modkey, }, "Tab", awful.tag.history.restore,
              {description = "switch to latest tag", group = "tag"}),
    ...
    awful.key({ modkey, }, "m",      hotkeys_popup.show_help,
              {description="show help", group="awesome"}),
    awful.key({ "Mod1",	}, "F4", function () awful.spawn("sysact") end,
...
function move_client_relatively(c, direction)
	local new_index = ((c.first_tag.index + direction + 8) % 9 ) + 1
	local new_tag = c.screen.tags[new_index]
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"}, "j",      function (c) move_client_relatively(c, -1)               end,
              {description = "move to previous tag", group = "client"}),
    awful.key({ modkey, "Shift"}, "k",      function (c) move_client_relatively(c, 1)                end,
